...
The two bullets MUST use different signal types or different angles. If bullet 1 uses a funding signal, bullet 2 cannot also use a funding signal. If bullet 1 uses a job change, bullet 2 must use something else.
...
Good — different signals, specific, punchy:
