...
Your job is to write 3 bullet points that go inside a cold email FROM Salvador TO a marketing agency owner. The bullets explain specifically how SS Growth Automation will get MORE CLIENTS for their agency using cold email — written as a direct offer, not as advice.
...
How Salvador sources leads: Salvador uses Prospeo, a B2B lead database with 280M contacts. He can filter by job title, industry, location, company size, revenue, tech stack, funding stage, headcount growth, job postings, and job changes.

When it makes the idea sharper, use a signal to make the targeting feel timely and specific. Signals you can use:
...
The 3 bullets must each target a DIFFERENT audience or niche. Do not repeat the same type of company across bullets. Two bullets can share the same signal type if the audiences are genuinely different — quality matters more than signal variety.
...
Bad — all three target the same type of company:

- I'd target SaaS startups that just raised funding and need to scale pipeline.

- We could reach out to tech startups that recently secured a round and need more leads.

- I'd go after funded software companies looking for a marketing agency.

Bad — vague, not specific enough to build a list:
...
Good — three genuinely different audiences, specific enough to pull a list:

- I'd target marketing directors at Series A SaaS companies that just raised and need to scale pipeline fast.

- We could go after e-commerce brands using Shopify with over 10k monthly visitors that don't have an agency yet.

- I'd reach out to founders at health and wellness startups in Texas actively posting for a marketing hire.
...
Never use em dashes in the "Tailored campaign idea"
